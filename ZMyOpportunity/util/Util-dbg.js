 ...
 */
jQuery.sap.declare("cus.crm.opportunity.util.Util");

cus.crm.opportunity.util.Util = {
 ...
 refreshHeaderETag : function(sPath,oController){
	...
	fetchPartnerFunctions : function(oModel){
		...
		oModel.read("PartnerFunctions",null,null,false,function(oData,response){
			...
			cus.crm.opportunity.util.Util.aggregatePartnerFunctions(oData.results);
			
		},function(oError){
			cus.crm.opportunity.util.Util.handleErrors(oError);
		});
	},
